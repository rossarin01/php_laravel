...
<html dir="ltr" lang="en">
  <head>
    ...
    <title>CPRU Research Management System</title>
    <!-- Favicon icon -->
    <link
      rel="icon"
      type="image/png"
            ...
            <ul id="sidebarnav" class="pt-4">
              ...
              <li class="sidebar-item">
                <a
                  ...
                  aria-expanded="false"
                  ><i class="mdi mdi-view-dashboard"></i
                  ><span class="hide-menu">ลงทะเบียนเรียน</span></a
                >
              </li>
              ...
              <!-- <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">ลงทะเบียน </span></a
                >
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a href="#" class="sidebar-link"
                      ><i class="mdi mdi-note-outline"></i
                      ><span class="hide-menu"> ข้อมูลการลงทะเบียน </span></a
                    >
                  </li>
                  <li class="sidebar-item">
                    <a href="#" class="sidebar-link"
                      ><i class="mdi mdi-note-plus"></i
                      ><span class="hide-menu"> ชำระค่าลงทะเบียน </span></a
                    >
                  </li>
                </ul>
              </li>
              ...
              <li class="sidebar-item">
                <a
                  ...
                  aria-expanded="false"
                  ><i class="mdi mdi-view-dashboard"></i
                  ><span class="hide-menu">ใบประกาศ</span></a
                >
              </li> -->
        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">มหาวิทยาลัยราชภัฏชัยภูมิ</h4>
